...
public:
    ...
    ConstantInt *compute(Instruction::OpID op, ConstantInt *value1,
                       ConstantInt *value2);
    ConstantFP *computefp(Instruction::OpID op, ConstantFP *value1,
                        ConstantFP *value2);
    ConstantInt *compute_comp(CmpInst::CmpOp op, ConstantInt *value1,
                            ConstantInt *value2);
    ConstantInt *compute_fcomp(FCmpInst::CmpOp op, ConstantFP *value1,
                             ConstantFP *value2);
    // ...
private:
    Module *module_;
